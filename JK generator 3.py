...
size=400
gap=4
colorModes=['alternant','gradient','gradient']
xy_same=True
...
for count in range(len(background_X)):
    if not np.random.randint(2): style_X+=pattern_smooth(background_X.pop(np.random.randint(len(background_X))),0,basicColor,rand_color(optionalColors))
for count in range(len(wide_X)):
    if not np.random.randint(3): style_X+=pattern_stripe_nonuniform(wide_X.pop(np.random.randint(len(wide_X))),np.random.randint(20,40)/100,np.random.randint(25,400)/100,np.random.randint(2,6),colorModes[np.random.randint(3)],basicColor,rand_color(optionalColors))
    else: style_X+=pattern_smooth(wide_X.pop(np.random.randint(len(wide_X))),np.random.randint(20,60)/100,basicColor,rand_color(optionalColors))
for count in range(len(narrow_X)):
    if not np.random.randint(2): style_X+=pattern_stripe_nonuniform(narrow_X.pop(np.random.randint(len(narrow_X))),np.random.randint(0,40)/100,np.random.randint(25,400)/100,np.random.randint(1,3),colorModes[np.random.randint(3)],rand_color(optionalColors),rand_color(optionalColors))
for multiline in multiline_X:
    if np.random.randint(3): style_X+=pattern_stripe_uniform(multiline,int(((multiline[1]-multiline[0])/(size/25)+1)/2),rand_color(optionalColors))
for thread in thread_X:
    if np.random.randint(3): style_X+=pattern_stripe_uniform(thread,int(((thread[1]-thread[0])/(size/100)+1)/2),threadColor)

for count in range(len(background_Y)):
    if not np.random.randint(2): style_Y+=pattern_smooth(background_Y.pop(np.random.randint(len(background_Y))),0,basicColor,rand_color(optionalColors))
for count in range(len(wide_Y)):
    if not np.random.randint(3): style_Y+=pattern_stripe_nonuniform(wide_Y.pop(np.random.randint(len(wide_Y))),np.random.randint(20,40)/100,np.random.randint(25,400)/100,np.random.randint(2,6),colorModes[np.random.randint(3)],basicColor,rand_color(optionalColors))
    else: style_Y+=pattern_smooth(wide_Y.pop(np.random.randint(len(wide_Y))),np.random.randint(20,60)/100,basicColor,rand_color(optionalColors))
for count in range(len(narrow_Y)):
    if not np.random.randint(2): style_Y+=pattern_stripe_nonuniform(narrow_Y.pop(np.random.randint(len(narrow_Y))),np.random.randint(0,40)/100,np.random.randint(25,400)/100,np.random.randint(1,3),colorModes[np.random.randint(3)],rand_color(optionalColors),rand_color(optionalColors))
for multiline in multiline_Y:
    if np.random.randint(3): style_Y+=pattern_stripe_uniform(multiline,int(((multiline[1]-multiline[0])/(size/25)+1)/2),rand_color(optionalColors))
for thread in thread_Y:
    if np.random.randint(3): style_Y+=pattern_stripe_uniform(thread,int(((thread[1]-thread[0])/(size/100)+1)/2),threadColor)
''' ---------- custom ---------- '''
